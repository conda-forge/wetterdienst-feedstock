...
Once the `conda-forge` channel has been enabled, `wetterdienst, wetterdienst-with-bufr, wetterdienst-with-duckdb, wetterdienst-with-eccodes, wetterdienst-with-excel, wetterdienst-with-export, wetterdienst-with-export-without-zarr, wetterdienst-with-influxdb, wetterdienst-with-interpolation, wetterdienst-with-matplotlib, wetterdienst-with-mysql, wetterdienst-with-pdf, wetterdienst-with-plotting, wetterdienst-with-postgresql, wetterdienst-with-radar, wetterdienst-with-radarplus, wetterdienst-with-restapi, wetterdienst-with-sql` can be installed with `conda`:

```
conda install wetterdienst wetterdienst-with-bufr wetterdienst-with-duckdb wetterdienst-with-eccodes wetterdienst-with-excel wetterdienst-with-export wetterdienst-with-export-without-zarr wetterdienst-with-influxdb wetterdienst-with-interpolation wetterdienst-with-matplotlib wetterdienst-with-mysql wetterdienst-with-pdf wetterdienst-with-plotting wetterdienst-with-postgresql wetterdienst-with-radar wetterdienst-with-radarplus wetterdienst-with-restapi wetterdienst-with-sql
```
