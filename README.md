...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/wetterdienst-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/wetterdienst-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
| [![Conda Recipe](https://img.shields.io/badge/recipe-wetterdienst--with--knmi-green.svg)](https://anaconda.org/conda-forge/wetterdienst-with-knmi) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/wetterdienst-with-knmi.svg)](https://anaconda.org/conda-forge/wetterdienst-with-knmi) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/wetterdienst-with-knmi.svg)](https://anaconda.org/conda-forge/wetterdienst-with-knmi) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/wetterdienst-with-knmi.svg)](https://anaconda.org/conda-forge/wetterdienst-with-knmi) |
...
| [![Conda Recipe](https://img.shields.io/badge/recipe-wetterdienst--with--mcp-green.svg)](https://anaconda.org/conda-forge/wetterdienst-with-mcp) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/wetterdienst-with-mcp.svg)](https://anaconda.org/conda-forge/wetterdienst-with-mcp) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/wetterdienst-with-mcp.svg)](https://anaconda.org/conda-forge/wetterdienst-with-mcp) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/wetterdienst-with-mcp.svg)](https://anaconda.org/conda-forge/wetterdienst-with-mcp) |
...
Once the `conda-forge` channel has been enabled, `wetterdienst, wetterdienst-with-bufr, wetterdienst-with-duckdb, wetterdienst-with-eccodes, wetterdienst-with-excel, wetterdienst-with-export, wetterdienst-with-export-without-zarr, wetterdienst-with-influxdb, wetterdienst-with-interpolation, wetterdienst-with-knmi, wetterdienst-with-matplotlib, wetterdienst-with-mcp, wetterdienst-with-mysql, wetterdienst-with-pdf, wetterdienst-with-plotting, wetterdienst-with-postgresql, wetterdienst-with-radar, wetterdienst-with-radarplus, wetterdienst-with-restapi, wetterdienst-with-sql` can be installed with `conda`:

```
conda install wetterdienst wetterdienst-with-bufr wetterdienst-with-duckdb wetterdienst-with-eccodes wetterdienst-with-excel wetterdienst-with-export wetterdienst-with-export-without-zarr wetterdienst-with-influxdb wetterdienst-with-interpolation wetterdienst-with-knmi wetterdienst-with-matplotlib wetterdienst-with-mcp wetterdienst-with-mysql wetterdienst-with-pdf wetterdienst-with-plotting wetterdienst-with-postgresql wetterdienst-with-radar wetterdienst-with-radarplus wetterdienst-with-restapi wetterdienst-with-sql
```

or with `mamba`:

```
mamba install wetterdienst wetterdienst-with-bufr wetterdienst-with-duckdb wetterdienst-with-eccodes wetterdienst-with-excel wetterdienst-with-export wetterdienst-with-export-without-zarr wetterdienst-with-influxdb wetterdienst-with-interpolation wetterdienst-with-knmi wetterdienst-with-matplotlib wetterdienst-with-mcp wetterdienst-with-mysql wetterdienst-with-pdf wetterdienst-with-plotting wetterdienst-with-postgresql wetterdienst-with-radar wetterdienst-with-radarplus wetterdienst-with-restapi wetterdienst-with-sql
```
